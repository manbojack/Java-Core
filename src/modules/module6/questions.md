...
> <b>Можно</b> параметризировать только <b>ссылочные типы</b>.    
> <b>Нельзя</b> параметризировать <b>примитивы</b>, нельзя параметризировать <b>enum</b>, <b>анонимные классы</b> и классы-
исключения (<b>Exception</b>). Невозможно объявить статические поля, типы которых являются параметрами типа.
