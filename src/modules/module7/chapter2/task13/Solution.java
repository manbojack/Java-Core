package modules.module7.chapter2.task13;
...
public class Solution {
    public static void main(String[] args) {
        // Random variables
        String randomFrom = "Elon Musk"; // Некоторая случайная строка. Можете выбрать ее самостоятельно.
        String randomTo = "Predator";  // Некоторая случайная строка. Можете выбрать ее самостоятельно.
